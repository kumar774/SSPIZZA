...
import { UtensilsCrossed, LayoutDashboard, Menu, Settings as SettingsIcon, LogOut, ExternalLink, Calculator, ShoppingBag, TrendingUp, PieChart, FileText, Wallet, Store, ChevronDown, PlusCircle, Users } from 'lucide-react';
...
interface DashboardProps {
  view: 'overview' | 'menu' | 'settings' | 'pos' | 'orders' | 'expenses' | 'reports' | 'restaurants' | 'restaurants-new' | 'restaurants-edit';
}
